...
const MESSAGES = {
  zh: {
    ...
    'tray.balance': '余额：{value}',
    'tray.todayUsage': '今日已用：{value}',
    ...
    'log.whaleMissing': '随包的插件 {name} 未找到，挂件将不会出现',
    'log.pluginNotInstalled': '插件 {name} 未能安装到 profile，挂件将不会出现',
  ...
  en: {
    ...
    'tray.balance': 'Balance: {value}',
    'tray.todayUsage': 'Used today: {value}',
    ...
    'quick.hide': 'Hide the floating window',
    ...
    'log.whaleMissing': 'Bundled plugin {name} was not found; the widget will not appear',
    'log.pluginNotInstalled': 'Plugin {name} could not be installed into the profile; the widget will not appear',
